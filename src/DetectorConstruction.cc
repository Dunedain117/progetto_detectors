...
:G4VUserDetectorConstruction(),
 fAbsorberMaterial(0),fDefaultMaterial(0),
...
fDefaultMaterial = man->FindOrBuildMaterial("G4_WATER");
// print table
//
...
G4VPhysicalVolume* DetectorConstruction::ConstructCalorimeter()
{
  ...
  //ComputeCalorParameters();WATE
   
  fWorldSizeX = fAbsorberThickness;
  ...
  if (fAbsorberThickness > 0.) 
    { fSolidAbsorber = new G4Box("Absorber",                //its name
                          fAbsorberThickness/2,fWorldSizeYZ/2,fWorldSizeYZ/2); 
  ...
  // Layer
  //
      fLayerThickness = fWorldSizeYZ/fNbOfLayers;
      fSolidLayer = new G4Box("Layer",                        //its name
                       fLayerThickness/2,fWorldSizeYZ/2,fWorldSizeYZ/2); //size
